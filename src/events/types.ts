...
export type WildcardArgs<TEventMap, TStrict extends boolean> = [eventName: EventNames<TEventMap, TStrict>, ...args: TEventMap[keyof TEventMap] extends infer U ? U extends any[] ? U : any[] : any[]]
